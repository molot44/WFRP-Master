teraz w zaznaczonej części na zielono ekranu w prawym dolnym rogu, równo na wysokości z przyciskiem Zawsze na wierzchu dodaj taką ramkę jak za przyciskiem 
Zawsze na wierchu (szarą, tej samej wysokości) i tam umieść w równych odstępach (nie za blisko żeby łatwo sie klikało bo jak beda za blisko to można zmissclickować 
ale też nei za daleko żeby było estetycznie) przyciski z folderu /assets:
- foundry_icon.png po kliknięciu prowadzi do https://foundryvtt.com/packages/modules
- reddit_icon.png po kliknięciu prowadzi do https://www.reddit.com/r/FoundryVTT/
- youtube_icon.png po kliknięciu prowadzi do https://www.youtube.com/results?search_query=foundry+vtt+module&sp=CAI%253D

dodaj też molten_icon.png z /assets jako kolejną ikonę obok discorda, notion i gimpa. Niech otwiera po kliknięciu https://molot.moltenhosting.com/
...
def main():
    ...
    buttons = [
        ("Lokacja", open_location),
        ("Wypowiedzi", open_wypowiedzi),
    ...
    if notion_icon and discord_icon:
        ...
        discord_photo = ImageTk.PhotoImage(discord_icon.resize((40, 40), Image.Resampling.LANCZOS))
